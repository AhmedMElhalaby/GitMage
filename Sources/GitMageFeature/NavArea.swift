...
enum NavArea: String, CaseIterable, Identifiable {
    ...
    var isReserved: Bool {
        switch self {
        case .changes, .history, .branches, .stashes: return false
        default: return true
        }
    }

    static var built: [NavArea] { [.changes, .history, .branches, .stashes] }
    static var reserved: [NavArea] { [.pullRequests, .issues, .worktrees, .advanced] }
}
